...
class KeyTerm():
    def __init__(self, data_dir = "/Users/andrazrepar/Koda/rsdo/DS5/terminology-extraction/DS5", language = 'sl', term = "linguistics", nes=False):
        ...
        self.df = pd.read_csv(data_file, sep='\t', names=['word'], header=None)
        self.nlp = stanza.Pipeline(lang='sl')
...
class ActerDataset():
    def __init__(self, data_dir = "/Users/andrazrepar/Koda/rsdo/DS5/terminology-extraction/DS5", language = 'sl', nes=False):
        if language == 'en':
        ...
        for term in ['linguistics','veterinary','chemistry']:
...
if __name__ == '__main__':
    ...
    path = "/Users/andrazrepar/Koda/rsdo/DS5/terminology-extraction/processed_data/sl"
